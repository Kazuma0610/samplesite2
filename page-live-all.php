    ...
    <section id="primary" class="content-area">
        <div class="live-sch-container">
                    ...
                    <div class="live-sch-wrapper">
                      <ul class="live-tab">
		                    <li class="tab__item selected"><a href="#all" class="js-tab-link selected">ALL</a></li>
                        ...
                        <li class="tab__item"><a href="https://ec-daieirecord.com/live-archive" class="js-tab-link">ARCHIVE</a></li>
	                    </ul>
                    </div>

                    <div id="all" class="live-area js-tab-box">
                      <div class="pagination">
                        ...
                        <?php
                          ...
                          ?>
                            ...
                            <?php endwhile;?>
                            <?php else://ライブ予定がない場合?>
                              <li class="no_live">現在LIVEの予定はありません</li>
                            <? endif;
                            wp_reset_postdata(); ?>
                        </ul>
