        ...
        <div class="news-sch-container">
                    ...
                    <div class="news-sch-wrapper">
                      <ul class="news-tab">
		                    ...
		                    <li class="tab__item"><a href="https://ec-daieirecord.com/news-media" class="js-tab-link">MEDIA</a></li>
		                    <li class="tab__item"><a href="https://ec-daieirecord.com/news-tv" class="js-tab-link">TV</a></li>
                            <li class="tab__item selected"><a href="#" class="js-tab-link selected">WEB</a></li>
                      ...
                      <div class="pagination">
                        ...
                        <?php
                          ...
                          $the_query = new WP_Query(array(
                            ...
                            'category__in' => array(28),// 複数のカテゴリーを取得（IDで取得）
